...
class AiPatchEvaluationService(base.PatchEvaluationService):
    def __init__(
        self,
        model: BaseChatModel,
        ...
        ] = self.prompt_store.patch_evaluation_trimming | model.with_structured_output(
    ...
    def get_full_evaluation(self, patch_build: str) -> common_dto.PatchEvaluationDto:
        return self.client.get_patch_evaluation(patch_build)

    def get_trimmed_evaluation(self, patch_build: str) -> common_dto.PatchEvaluationDto:
        evaluation = self.get_full_evaluation(patch_build)
...
class IterativePatchEvaluationService(base.PatchEvaluationService):
    def __init__(
        self,
        client: clients.HBITClient,
        n_vulnerabilities: int = settings.N_VULNERABILITIES,
